...
contract TesterTSS is ERC721Enumerable, Ownable {
  ...
  uint256 public presaleStart = 1638582600;
  uint256 public saleStart = 1638582900;
  ...
  address[] _addresses = [0x4E2CC19317d23680AAfE52189491D12F890c3c02,0xd4aE60d4aF6dEc4de59bf5AC280355060871Dc79];

  constructor(
    string memory _initBaseURI
  ) ERC721("TSTCON", "TSTCON") {
    setBaseURI(_initBaseURI);
    reserveForGiveaway(10);
    setWhitelistBalances();
  }
